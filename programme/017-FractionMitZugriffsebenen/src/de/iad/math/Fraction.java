...
public class Fraction {
    ...
    // Zustand eines de.iad.math.Fraction-Objekts -> Instanzfelder / Instanzvariablen
    ...
    // Verhalten / Handlungskompetenz von de.iad.math.Fraction-Objekten -> Instanzmethoden
    public void print() {
    ...
    public void printAsMixedNumber() {
    ...
    public static Fraction of(int wholes, Fraction fraction) {
